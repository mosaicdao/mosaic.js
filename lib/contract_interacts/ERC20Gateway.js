...
const gatewayJsonInterface = parseFile('../../contracts/abi/Gateway.abi', 'utf8'),
  coGatewayJsonInterface = parseFile('../../contracts/abi/CoGateway.abi', 'utf8');

const ERC20Gateway = function(originAddress, originOptions, auxilaryConfig, auxiliaryAddress, auxiliaryOptions) {
  const oThis = this,
    ...
    auxilaryGateway = new auxilaryWeb3Obj.eth.Contract(
      coGatewayJsonInterface,
      auxiliaryAddress,
      auxiliaryOptions || {}
    );
