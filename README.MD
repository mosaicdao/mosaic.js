...
const stakeResponse = facilitator
  .stake(
    staker,
    amount,
    beneficiary,
...
// stakeResponse.blockNumber: Block height at which stake was done.
facilitator
  .progressStake(
    staker,
    amount,
...
const redeemResponse = facilitator
  .redeem(
    redeemer,
    redeemAmount,
    beneficiary,
...
// redeemResponse.blockNumber: Block height at which redeem was done.
facilitator
  .progressRedeem(
    redeemer,
    nonce,
