...
![Build develop](https://img.shields.io/travis/OpenSTFoundation/mosaic.jsts/develop.svg?label=build%20develop&style=flat)
...
```js
// Expecting Mosaic impart and an instance of `mosaic`:
