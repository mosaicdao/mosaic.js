...
// blockNumber: Block height at which stake was done. 
// Facilitator.stake returns blockNumber.
facilitator
  .progressStake(
    staker,
    amount,
...
// blockNumber: Block height at which redeem was done. 
// Facilitator.redeem returns blockNumber.
facilitator
  .progressRedeem(
    redeemer,
    nonce,
