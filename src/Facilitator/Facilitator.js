              ...
              .then(() => {
                ...
                this.coGateway
                  ...
                  .then((confirmStakeIntentResult) => {
                    ...
                    return onResolve(confirmStakeIntentResult);
                  })
                  .catch(onReject);
              })
              .catch((exception) => {
      ...
      if (
        ...
        this.gateway
          ...
          .then((progressStakeResult) => {
            ...
            return onResolve(progressStakeResult);
          })
          .catch((exception) => {
      ...
      if (
        ...
        this.coGateway
          ...
          .then((progressMintResult) => {
            ...
            return onResolve(progressMintResult);
          })
          .catch((exception) => {
